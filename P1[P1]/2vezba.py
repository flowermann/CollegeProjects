...
file = data("linux_commits.csv")
if file:
    corrected_file = group_commit_hash(file)
    if corrected_file:
        large_commits(corrected_file)
        file_changes(corrected_file)
        range_changes(corrected_file)
